                ...
                if ($result['@attributes']['status'] != 'Success') {
                    ...
                    foreach ($products as $product) {
                        ...
                        if (isset($product['Relationships']['VariationChild'])) {
                            ...
                            $children = $product['Relationships']['VariationChild'];
                            if (is_string(array_key_first($children))) {
                                $array['Relationships'][] = $children['Identifiers']['MarketplaceASIN']['ASIN'];
                            } else {
                                foreach ($children as $variation_child) {
                                    $array['Relationships'][] = $variation_child['Identifiers']['MarketplaceASIN']['ASIN'];
                                }
                            }
                        }
